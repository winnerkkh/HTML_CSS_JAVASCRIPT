...
window.onload = function(){
      ...
      for ( var i=0; i<images.length; i++ ){
          myImageStr += '<figure>' + '<img src = "' + images[i].url +'"  alt = "' + images[i].alt + '" />' + "<figcaption>" + images[i].caption + "</figcaption>" + "</figure>";          
      }

      imageContainer.innerHTML = myImageStr; // add the new imag
};
